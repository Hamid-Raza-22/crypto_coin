              ...
              children: [
                Column(
                  children: [
                    ...
                    Text(
                      '${resources?['energy']['available'] ?? "0"}',
                      style: TextStyle(
                        color: resources?['energy']['available'] == 0
                            ? Colors.red
                            : Colors.green,
                      ),
                    ),
                ...
                Column(
                  children: [
                    const Icon(
                        Icons.network_wifi, color: Colors.blue, size: 30),
                    const SizedBox(height: 5),
                    const Text(
                      'Bandwidth',
                      style: TextStyle(
                    ...
                    Text(
                      '${resources?['bandwidth']['available'] ?? "0"}',
                      style: TextStyle(
                        color: resources?['bandwidth']['available'] == 0
                            ? Colors.red
                            : Colors.green,
                      ),
                    ),
